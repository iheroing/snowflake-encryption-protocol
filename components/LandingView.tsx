  ...
  return (
    <main className="relative z-10 min-h-screen w-full flex flex-col items-center justify-center text-center px-6">
      ...
      <div onClick={onCrystallize} className="relative group cursor-pointer transition-all duration-700 hover:scale-105">
        ...
        <div className="relative w-64 h-64 md:w-80 md:h-80 flex items-center justify-center animate-[bounce_6s_ease-in-out_infinite]">
          <div className="absolute inset-0 bg-primary/20 rounded-full blur-[40px] animate-pulse"></div>
          
          <div className="relative z-20 w-48 h-48 md:w-56 md:h-56 overflow-hidden rounded-full border border-white/10 backdrop-blur-sm bg-white/5 flex items-center justify-center">
            <img 
      ...
      <div className="fixed left-8 bottom-8 flex flex-col gap-6 opacity-30 hover:opacity-100 transition-opacity">
        <div className="w-px h-24 bg-gradient-to-t from-primary to-transparent mx-auto"></div>
